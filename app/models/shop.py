...
Defines tables for categories, materials, tags, items, item images, and wishlists.
"""
...
class Category(Base):
    """Category model for organizing furniture items."""
...
class Material(Base):
    """Material model for furniture construction materials."""
...
class Tag(Base):
    """Tag model for categorizing and filtering items."""
    __tablename__ = 'tags'
...
class Item(Base):
    """Item model representing furniture products."""
    __tablename__ = 'items'
...
class ItemImage(Base):
    """ItemImage model for storing product images."""
    ...
    # Index for efficient primary image lookups
    __table_args__ = (
...
class Wishlist(Base):
    """Wishlist model for user-specific saved items."""
